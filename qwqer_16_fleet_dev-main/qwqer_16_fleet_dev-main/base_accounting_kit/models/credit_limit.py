...
class SaleOrder(models.Model):
    ...
    #INFO This code has been removed because creation of sale order should not be restricted
...
class AccountMove(models.Model):
    ...
    #INFO This code has been removed because creation of invoice should not be restricted
