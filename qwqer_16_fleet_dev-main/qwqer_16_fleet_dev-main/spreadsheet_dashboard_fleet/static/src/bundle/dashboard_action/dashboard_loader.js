...
export class DashboardLoader {
     ...
     */
    getDashboardGroups(activeDashboardId) {
        return this.groups
            .filter(section => {
                // Check if activeDashboardId is provided and is not null/undefined/empty
                if (activeDashboardId) {
                    // Only include sections where activeDashboardId is in dashboardIds
                    return section.dashboardIds.includes(activeDashboardId);
                }
                // If no activeDashboardId, return all sections
                return true;
            })
            .map((section) => ({
                id: section.id,
                ...
                dashboards: section.dashboardIds.map((dashboardId) => {
                    ...
                    return {
                        ...
                        isActive: dashboardId === activeDashboardId, // Highlight active dashboard
                    };
                }),
            }));
    }
