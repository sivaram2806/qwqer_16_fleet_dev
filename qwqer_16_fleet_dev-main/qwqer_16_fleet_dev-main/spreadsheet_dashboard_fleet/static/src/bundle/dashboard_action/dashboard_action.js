...
export class SpreadsheetDashboardAction extends Component {
    ...
    getDashboardGroups() {
        return this.loader.getDashboardGroups(this.props.action.params.dashboard_id);
    }
...
SpreadsheetDashboardAction.template = "spreadsheet_dashboard_fleet.DashboardAction";
...
registry
    .category("actions")
    .add("action_spreadsheet_dashboard_fleet", SpreadsheetDashboardAction, { force: true });
