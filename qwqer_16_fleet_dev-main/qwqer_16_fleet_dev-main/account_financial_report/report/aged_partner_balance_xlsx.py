    ...
    def _get_report_columns(self, report):
        ...
        if not report.show_move_line_details:
            return {
                ...
                1: {"header": _("Customer ID"), "field": "customer_ref_key", "width": 18},
                2: {"header": _("Service Type"), "field": "service_type_id", "width": 18},
                3: {"header": _("Region"), "field": "region_id", "width": 14},
                4: {"header": _("Sales Person"), "field": "sales_person", "width": 25},
                5: {
                    "header": _("Residual"),
                    "field": "residual",
        ...
        return {
            ...
            5: {"header": _("Customer ID"), "field": "customer_ref_key", "width": 18},
            6: {"header": _("Service Type"), "field": "service_type_id", "width": 25},
            7: {"header": _("Ref - Label"), "field": "ref_label", "width": 40},
            8: {"header": _("Due date"), "field": "due_date", "width": 11},
            9: {"header": _("Region"), "field": "region_id", "width": 14},
            10: {"header": _("Sales Person"), "field": "sales_person", "width": 25},
            11: {
                "header": _("Residual"),
                "field": "residual",
                "field_footer_total": "residual",
