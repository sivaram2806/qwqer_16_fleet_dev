...
class AbstractReportXslx(models.AbstractModel):
    ...
    def _define_formats(self, workbook, report_data):
        ...
        report_data["formats"] = {
            ...
            "format_header_internal_type": workbook.add_format(
                {"bold": True, "border": False, "font_color": "#1811ed", "align": "center"}
            ),
    ...
    def write_line_from_dict(self, line_dict, report_data):
        ...
        for col_pos, column in report_data["columns"].items():
            ...
            if cell_type == "string":
                ...
                elif line_dict.get("type", "") == "internal_type":
                    report_data["sheet"].write_string(
                        report_data["row_pos"],
                        col_pos-2,
                        value or "",
                        report_data["formats"]["format_header_internal_type"],
                    )
                else:
                    if (
