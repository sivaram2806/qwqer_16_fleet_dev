...
class AccountMoveLine(models.Model):
    ...
    analytic_account_ids = fields.Many2many(
        "account.analytic.account", relation="account_analytic_account_account_move_line_rel",
        column1='account_move_line_id', column2='account_analytic_account_id',
        compute="_compute_analytic_account_ids", store=True
    )
